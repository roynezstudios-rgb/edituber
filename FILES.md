...
- `apps/web-lab/src/App.tsx`: preview y controles responsive.
...
- `packages/contracts/schema/edituber-project.schema.json`: contrato v1.
- `packages/contracts/src`: tipos, un solo grapheme por emoji y validación.
...
- `packages/avatar-engine/src`: selección de estados, blink y talkBounce.
...
- `fixtures/projects/demo.edituber.json`: proyecto de 6 segundos y tres expresiones.
